...
#[get("/")]
pub fn get_all(conn: DatabaseConnection) -> Result<Json<Vec<Supplier>>, rocket::response::status::Custom<&'static str>> {
...
#[get("/<id>")]
pub fn get(conn: DatabaseConnection, id: String) -> Result<Json<Supplier>, rocket::response::status::Custom<&'static str>> {
...
pub fn insert(conn: DatabaseConnection,new_supplier: Json<NewSupplier>) -> Result<Json<Supplier>, rocket::response::status::Custom<&'static str>> {
...
#[delete("/<id>")]
pub fn delete(conn: DatabaseConnection, id: String) -> Result<Json<CustomResponse>, rocket::response::status::Custom<&'static str>> {
