...
pub fn format_currency(amount: i64, currency: Currency) -> Result<String, &'static str> {
    ...
    if amount < 0 {
        ...
        return Ok(result
            .replace("%s", &currency_setup.symbol.clone())
            .replace("%v", &formatted_amount));
    } else {
...
fn format_amount(_amount: i64, currency_setup: &CurrencySetup) -> String {
...
fn get_config_from_currency(currency: Currency) -> CurrencySetup {
    return match currency {
        ...
        Currency::USD => CurrencySetup::new(
            String::from("$"),
            2,
            String::from(","),
            String::from("."),
        ...
        Currency::EUR => CurrencySetup::new(
            String::from("€"),
            2,
            String::from(","),
            String::from("."),
        ...
        Currency::SEK => CurrencySetup::new(
            String::from("kr"),
            2,
            String::from(","),
            String::from("."),
