function CalendarView(output_id, format) {
	...
	this.init = function() {
		...
		this.output.addEventListener("focus", function() {
			...
			window[this.getAttribute("data-calendar-widget")+"-calendarWidget"].holder.style.left = this.style.left + "px";
			window[this.getAttribute("data-calendar-widget")+"-calendarWidget"].holder.style.top = (this.style.top+this.style.height) + "px";
